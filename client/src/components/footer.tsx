    ...
    <footer className="site-footer" role="contentinfo">
      <div className="sm-container">
        <div className="footer-grid">
          <div>
            <img src={logoImage} alt="Self-Maid Cleaning Solutions" className="footer-logo-img" width="160" height="60" loading="lazy" style={{ mixBlendMode: 'lighten' }} />
          ...
          <div className="footer-col">
            ...
            <Link href="/services">Apartment Turnover</Link>
          </div>
          ...
          <div className="footer-col">
            ...
            <a href="https://www.google.com/maps/search/Self-Maid+Cleaning+Solutions+Montgomery+AL" target="_blank" rel="noopener noreferrer" className="footer-review-link">Leave a Review &#10024;</a>
          </div>

          <div className="footer-col">
            <h4>SERVICE AREAS</h4>
            <p>Montgomery &middot; Prattville &middot; Millbrook &middot; Wetumpka &middot; Pike Road &middot; Selma &middot; Homewood &middot; Clanton &middot; Alabaster</p>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-inner">
          ...
          <div className="footer-links-row">
            ...
            <span>&middot;</span>
            <span className="powered-by">LEADING EDGE GROWTH</span>
          </div>
        </div>
      </div>
    </footer>
