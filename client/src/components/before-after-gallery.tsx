  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        >
          <div className="w-[2px] h-full" style={{ background: 'rgba(201,160,32,0.6)' }} />
          <div className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-10 h-10 rounded-full flex items-center justify-center" style={{ background: '#0a0a0d', border: '2px solid rgba(201,160,32,0.6)', boxShadow: '0 4px 20px rgba(0,0,0,0.5)' }}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#c9a020" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <span className="absolute top-3 right-3 z-20 text-[10px] font-medium px-3 py-1.5 rounded tracking-[1px] uppercase" style={{ background: 'rgba(201,160,32,0.9)', color: '#0a0a0d' }}>
          After
        </span>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <h2 className="font-bold text-white font-serif">
            See the Real <span className="italic" style={{ color: '#c9a020' }}>Difference</span>
          </h2>
