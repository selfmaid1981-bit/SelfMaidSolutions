...
export function FinalCtaSection() {
  return (
    <section className="relative overflow-hidden py-16 lg:py-24" style={{ background: 'linear-gradient(135deg, #1F2A37 0%, #2D3F52 40%, #166B50 60%, #1F2A37 100%)' }}>
      ...
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-emerald-300/8 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a href="/quote">
                <Button className="bg-gradient-to-r from-[#1E8E6A] to-[#166B50] hover:from-[#34D399] hover:to-[#1E8E6A] text-white font-bold px-10 py-6 rounded-2xl text-lg h-auto shadow-xl shadow-emerald-500/25 hover:shadow-2xl transition-all btn-shine">
                  Get Your Free Quote
