...
import heroImg from '@assets/C1779863-20FF-4284-87E7-F8622C11FE8C_1773603022797.png';

export function FinalCtaSection() {
  return (
    <section className="relative overflow-hidden py-16 lg:py-24" style={{ background: 'linear-gradient(135deg, #1C2D3A 0%, #0d7a52 40%, #19A974 60%, #1C2D3A 100%)' }}>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <a href="/quote">
                <Button className="bg-gradient-to-r from-[#19A974] to-[#0d7a52] hover:from-[#19A974] hover:to-[#19A974] text-white font-bold px-10 py-6 rounded-2xl text-lg h-auto shadow-xl shadow-emerald-500/25 hover:shadow-2xl transition-all btn-shine">
                  Get Your Free Quote
