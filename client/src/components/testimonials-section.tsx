...
export function TestimonialsSection() {
  return (
    <section className="py-10 lg:py-16 relative overflow-hidden section-gradient-teal">
      ...
      <div className="absolute bottom-10 left-10 w-72 h-72 bg-emerald-400/15 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          {testimonials.map((testimonial) => (
            ...
            >
              <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-emerald-400 via-teal-400 to-teal-500 opacity-50 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-br from-teal-400/5 to-emerald-400/5 rounded-full group-hover:from-teal-400/10 group-hover:to-emerald-400/10 transition-all duration-500" />
        ...
        <div className="text-center bg-white/95 dark:bg-slate-800/95 backdrop-blur-md rounded-3xl p-10 shadow-2xl border border-white/60 dark:border-slate-700/50 relative overflow-hidden">
          <div className="absolute -top-10 -right-10 w-40 h-40 bg-gradient-to-br from-emerald-400/10 to-teal-400/10 rounded-full blur-2xl pointer-events-none" />
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="tel:3348779513"
                className="inline-flex items-center justify-center bg-gradient-to-r from-emerald-600 to-emerald-700 hover:from-emerald-700 hover:to-emerald-800 text-white px-8 py-4 rounded-xl text-lg font-semibold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300"
              ...
              <a
                href="/quote"
                className="inline-flex items-center justify-center bg-white dark:bg-slate-700 text-emerald-600 dark:text-emerald-400 border-2 border-emerald-500 dark:border-emerald-400 hover:bg-emerald-50 dark:hover:bg-slate-600 px-8 py-4 rounded-xl text-lg font-semibold shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300"
