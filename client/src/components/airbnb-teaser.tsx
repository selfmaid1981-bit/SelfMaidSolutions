...
export function AirbnbTeaser() {
  return (
    <section className="py-20 lg:py-24 deep-teal-bg text-white relative overflow-hidden">
      <div className="absolute top-0 right-0 w-96 h-96 bg-[#C6A969]/5 rounded-full blur-3xl" />
      <div className="absolute bottom-0 left-0 w-72 h-72 bg-[#C6A969]/5 rounded-full blur-3xl" />

      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-[#C6A969]/20 border border-[#C6A969]/30 text-[#C6A969] px-4 py-1.5 rounded-full text-sm font-semibold mb-6">
              <Key className="w-4 h-4" /> Airbnb & Vacation Rental Hosts
            </div>

            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
              Boost Your Ratings.<br />
              <span className="text-[#C6A969]">Fill More Nights.</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Link href="/airbnb-cleaning">
                <Button size="lg" className="gold-bg text-[#1F2A37] font-bold px-6 py-5 hover:opacity-90">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-2xl p-5">
              <TrendingUp className="w-8 h-8 text-[#C6A969] mb-3" />
            ...
            <div className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-2xl p-5">
              <Key className="w-8 h-8 text-[#C6A969] mb-3" />
